...
class Command(BaseCommand):
    ...
    def import_target_facebook_data(self, str_target_account, str_name):
        ...
        for post in c:
            if self.bln_qtd_test and self.i_fb > self.int_qtd_test:
                break
    ...
    def import_target_twitter_data(self, str_target_account, str_name):
        ...
        for post in c:
            if self.bln_qtd_test and self.i_tw > self.int_qtd_test:
                break
    ...
    def import_target_instagram_data(self, str_target_account, str_name):
        ...
        for post in c:
            if self.bln_qtd_test and self.i_in > self.int_qtd_test:
                break
